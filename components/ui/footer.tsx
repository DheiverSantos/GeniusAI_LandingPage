        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
              ...
              <li className="ml-4">
              <Link href={linkWTS} target="_blank" className="flex justify-center items-center text-white bg-blue-700 hover:bg-green-500 rounded-full transition duration-150 ease-in-out" aria-label="WhatsApp">
