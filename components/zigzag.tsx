        ...
        <div className="py-12 md:py-20">
          ...
          <div className="grid gap-20">
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  <div className="text-xl text-blue-700 mb-2 text-center">Missão de Inovação</div>
                  <h2 className="h3 mb-3 text-center">Reinventando o Diagnóstico Médico</h2>
                  ...
                  <ul className="text-lg text-gray-600 -mb-2">
                    ...
                    <li className="flex items-center mb-2">
                      ...
                      <span>Pesquisa Médica Avançada</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
                      </svg>
                      <span>Elevando o Padrão Médico</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-left">
                <div className="md:pl-4 lg:pl-12 xl:pl-16">
                  <div className="text-xl text-blue-700 mb-2 text-center">Impulsionando a Saúde Moderna</div>
                  <h2 className="h3 mb-3 text-center">Revolucionando o Cuidado de Saúde com Precisão</h2>
                  ...
                  <ul className="text-lg text-gray-600 -mb-2">
                    <li className="flex items-center mb-2">
                      ...
                      <span>Precisão Diagnóstica</span>
                    </li>
                    <li className="flex items-center mb-2">
                      <svg className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
                    ...
                    <li className="flex items-center">
                      ...
                      <span>Eficiência nos Recursos de Saúde</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  <div className="text-xl text-blue-700 mb-2 text-center">Descobrindo o Futuro</div>
                  <h2 className="h3 mb-3 text-center">Inovando a Interpretação de Imagens</h2>
                  ...
                  <ul className="text-lg text-gray-600 -mb-2">
                    <li className="flex items-center mb-2">
                      ...
                      <span>Transformação da Interpretação de Imagens</span>
                    </li>
                    <li className="flex items-center mb-2">
                      <svg className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
                      </svg>
                      <span>Suporte de Decisão Médica</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
                      </svg>
                      <span>Avanço Tecnológico na Medicina</span>
                    </li>
                  </ul>
                </div>
              </div>
