        ...
        <div className="fixed bottom-0 right-0 w-full md:bottom-8 md:right-12 md:w-auto z-50">
          <div className="bg-slate-800 text-slate-50 text-sm p-3 md:rounded shadow-lg flex justify-between">
            <div className="text-slate-500 inline-flex">       
              <Link href="https://api.whatsapp.com/send?phone=SEUNUMERODOTELEFONE" target="_blank" className="flex justify-center items-center text-white bg-green-500 hover:bg-green-600 rounded-full transition duration-150 ease-in-out" aria-label="WhatsApp">
